...
$table.= '<button type="button" class="close" aria-label="Close" onclick="CLOSE_DIV('."'table2'".');" >
 ...
 <tbody >';
  ...
  <a href="'.URL.'index.php?url=ges_requisiciones/req_copy/'.$inv.'/OC"  class="btn btn-block btn-secondary btn-icon btn-icon-standalone btn-icon-standalone-right btn-single text-left">
     <img  class="icon" src="img/File Send.png" />
    <span>Copiar</span>
  </a>
  </div>';
